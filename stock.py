...
# 数据库名称和密码
name = 'root'
password = '18279438873'  # 替换为自己的账户名和密码
...
for fileName in fileList:
    ...
    sqlSentence3 = "create table if not exists stock_%s" % fileName[0:6] + "(日期 date, 股票代码 VARCHAR(10), 名称 VARCHAR(10),\
    ...
    for i in range(0, length):
        ...
        # 插入数据语句
        try:
            sqlSentence4 = "insert into stock_%s" % fileName[0:6] + \
